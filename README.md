...
- Game/client updater (manifest-based patcher with parallel downloads, verify/repair and re-download-all)
- Update ignore list: exact paths or wildcards (`*`, `?`) for files the patcher must never touch (Settings and the folder-select dialog)
- Built-in Nexon news feed, themed to the active VCL style
